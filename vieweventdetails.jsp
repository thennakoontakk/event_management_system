    ...
    <div class="row">
        <div class="col-md-8">
            <div class="user mt-5">
                ...
                <table class="table">
                    ...
                    <c:set var="eventid" value="${cus.eventid}"/><!-- this line internally call to the get CID method in Customer class -->
					<c:set var="eventtype" value="${cus.eventtype}"/>
					...
					<c:set var="price" value="${cus.price}"/>
                        <tr>
                            <td>Event Id</td>
                            <td><c:out value="${cus.eventid}" /></td>
                        </tr>
                        <tr>
                            <td>Event Type</td>
                            <td><c:out value="${cus.eventtype}" /></td>
                        </tr>
                        <tr>
                            <td>Venue</td>
                        ...
                        <tr>
                            <td>Additional</td>
                            <td><c:out value="${cus.additional}" /></td>
                        </tr>
                        <tr>
                            <td>Total Amount:</td>
                ...
                <br>
                <c:url value="eventdetailupdate.jsp" var="eventupdate"><!-- navigate to the updatecustomer page and show these details -->
				<c:param name="eventid" value="${eventid}"/><!-- CID is the variable name of set tag above -->
				...
				<c:param name="additional" value="${additional}"/>
        ...
        <div class="col-md-4">
            <div class="side-section mt-5">
                <a href="${eventupdate}" class="btn btn-info btn-block">Edit Event</a>
                
    <c:url value="eventdetaildelete.jsp" var="eventdelete">
		<c:param name="eventid" value="${eventid}"/><!-- CID is the variable name of set tag above -->
				<c:param name="eventtype" value="${eventtype}"/>
				<c:param name="venue" value="${venue}"/>
				<c:param name="date" value="${date}"/>
				...
				<c:param name="price" value="${price}"/>
    				 ...
    				 <a href="${eventdelete}" name="delete" class="btn btn-danger btn-block">Delete Account</a>
