...
<% //catch the details come from url in useraccount page
    ...
    <div class="container01">
        ...
        <form id="registration-form" action="deletecontact" method="post">
        
        	<label for="id">Contact Us ID</label>
            <input type="text" id="id" name="contactid" value="<%= contactid %>" readonly>
            ...
            <input type="tel" id="contact" name="phone" value="<%= phone %>"readonly pattern="[0-9]+" inputmode="numeric">

            <label for="username">Message</label>
            <input type="text" id="username" name="message" value="<%= message %>" readonly>
