...
CREATE TABLE `hiring` (
  `hiringid` int NOT NULL AUTO_INCREMENT,
  `name` varchar(45) DEFAULT NULL,
  `email` varchar(45) DEFAULT NULL,
  `phone` varchar(10) DEFAULT NULL,
  `dob` varchar(45) DEFAULT NULL,
  `address` varchar(45) DEFAULT NULL,
  `dancestyle` varchar(45) DEFAULT NULL,
...
INSERT INTO `hiring` VALUES (2,'sakila athapaththu','sakila@gmail.com','0714782241','2023-10-09','kurunegala','contemporary','two year');
