...
<nav class="navbar navbar-expand-lg navbar-light shadow">
 ...
 <div class="container01">
        ...
        <h1>Booking Event</h1>
        <form id="registration-form" action="eventint" method="post">
        
        	<label for="event">Event Type:</label>
   		<select id="eventtype" name="eventtype" required>
        <option disabled selected>Select event type</option>
        <option value="Birthday Parties" data-price="10000">Birthday Parties</option>
        <option value="Weddings" data-price="50000">Weddings</option>
        <option value="Sports Events" data-price="20000">Sports Events</option>
        <option value="Holiday Celebrations" data-price="10000">Holiday Celebrations</option>
        <option value="Festivals" data-price="30000">Festivals</option>
        <option value="Dj Party" data-price="25000">Dj Party</option>
        <option value="Anniversaries" data-price="10000">Anniversaries</option>
    </select>
            ...
            <input type="tel" id="contact" name="contact" required pattern="[0-9]+" inputmode="numeric">

			<label for="services">Additional Services:</label>
    <div class="custom-checkbox">
        <input type="checkbox" id="catering" name="additional" value="catering" data-price="10000">
        <label for="catering">Catering: Rs.10000.00</label>
    </div>
    <div class="custom-checkbox">
        <input type="checkbox" id="photographer" name="additional" value="photographer" data-price="5000">
        <label for="photographer">Photographer: Rs.5000.00</label>
    </div>
    <div class="custom-checkbox">
        <input type="checkbox" id="flora" name="additional" value="flora" data-price="2000">
        <label for="flora">Flora: Rs.2000.00</label>
    </div>
    <div class="custom-checkbox">
        <input type="checkbox" id="lighting" name="additional" value="lighting" data-price="5000">
        <label for="lighting">Lighting: Rs.5000.00</label>
    </div>

<input type="text" id="totalPrice" name="price" value="0.00">
            ...
            <button type="submit" name="sumbit" id="register-button" >Booking</button>
