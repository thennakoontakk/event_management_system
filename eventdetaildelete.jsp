...
<head>
    <meta charset="UTF-8">
    <title>Delete Event Booking</title>
    <style>
        body {
...
<% //catch the details come from url in useraccount page
		String eventid = request.getParameter("eventid");//id is the parameter name of CID in useraccount page inside url tag
    ...
    <div class="container01">
        ...
        <form id="registration-form" action="deleteevent" method="post">
        
        	<label for="id">Event ID</label>
            <input type="text" id="id" name="eventid" value="<%= eventid %>" readonly>
            
             <label for="name">Event Type</label>
            <input type="text" id="name" name="eventtype" value="<%= eventtype %>" readonly>
            
            <label for="name">Event Venue</label>
            <input type="text" id="name" name="venue" value="<%= venue %>" required>
            
            
            <label for="name">Event Date</label>
            <input type="date" id="name" name="date" value="<%= date %>" required>
            ...
            <input type="text" id="username" name="additional" value="<%= additional %>" readonly>
