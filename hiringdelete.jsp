...
<% //catch the details come from url in useraccount page
		String hiringid = request.getParameter("hiringid");//id is the parameter name of CID in useraccount page inside url tag
    ...
    <div class="container01">
        ...
        <form id="registration-form" action="deletehiring" method="post">
        
        	<label for="id">Hiring ID</label>
            <input type="text" id="id" name="hiringid" value="<%= hiringid %>" readonly>
            
             <label for="name">Name</label>
            <input type="text" id="name" name="name" value="<%= name %>" required>
            
            <label for="name">Email</label>
            <input type="email" id="name" name="email" value="<%= email %>" readonly>
            
            
            <label for="name">Phone</label>
            <input type="tel" id="name" name="phone" value="<%= phone %>" required pattern="[0-9]+" inputmode="numeric">
            
            <label for="name">Date of Birth</label>
            <input type="date" id="name" name="dob" value="<%= dob %>" required>

            <label for="email">Address</label>
            <input type="text" id="email" name="address" value="<%= address %>" required>

            <label for="username">Dance Style</label>
            <input type="text" id="username" name="dancestyle" value="<%= dancestyle %>" required>

            <label for="price">Experience</label>
            <input type="text" id="price" name="experience" value="<%= experience %>" readonly>
