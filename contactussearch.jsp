...
<form action="viewcontactdetails" method="post"> 
   <div class="view">
    	...
    	<input type="email" name="email" placeholder="Enter contact Email" required /><br>
        <button type="submit" class="btn btn-primary btn-block btn-large">Show contact details</button>
        </div>
    </form>
    </div>
