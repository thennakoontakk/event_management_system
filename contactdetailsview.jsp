...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            <div class="user mt-5">
                <h1 class="text-center">Contact Us Details</h1>
                <table class="table">
                    <c:forEach var="cus" items="${contactDetails}">
                   
                    <c:set var="contactid" value="${cus.contactid}"/><!-- this line internally call to the get CID method in Customer class -->
					...
					<c:set var="message" value="${cus.message}"/>
                        ...
                        <tr>
                            <td>Contact Us Id</td>
                            <td><c:out value="${cus.contactid}" /></td>
                        </tr>
                ...
                <br>
                <c:url value="contactusupdate.jsp" var="contactupdate"><!-- navigate to the updatecustomer page and show these details -->
				<c:param name="contactid" value="${contactid}"/><!-- CID is the variable name of set tag above -->
        ...
        <div class="col-md-4">
            <div class="side-section mt-5">
                <a href="${contactupdate}" class="btn btn-info btn-block">Edit Contact Us Details</a>
                
    <c:url value="contactdetaildelete.jsp" var="contactdelete">
		<c:param name="contactid" value="${contactid}"/><!-- CID is the variable name of set tag above -->
				<c:param name="name" value="${name}"/>
				<c:param name="email" value="${email}"/>
				<c:param name="phone" value="${phone}"/>
				<c:param name="message" value="${message}"/>
    				 ...
    				 <a href="${contactdelete}" name="delete" class="btn btn-danger btn-block">Delete </a>
