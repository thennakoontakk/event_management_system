...
<title>Hiring Performance Search</title>
<style>
        body {
...
<form action="viewhiring" method="post"> 
   <div class="view">
   
   		
    	<input type="email" name="email" placeholder="Enter Email" required /><br>
        <button type="submit" class="btn btn-primary btn-block btn-large">Show Hiring details</button>
        </div>
    </form>
    </div>
