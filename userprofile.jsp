    ...
    <div class="row">
            ...
            <div class="user mt-5">
                ...
                <table class="table">
					...
					<c:set var="password" value="${cus.password}"/>
                        ...
                        <tr>
   							 <td>Password</td>
    						 <td><input type="password" value="${cus.password}" readonly style="border: none; background: none;"></td>
						</tr>
                ...
                <br>
                <c:url value="cusprofileupdate.jsp" var="cusupdate"><!-- navigate to the updatecustomer page and show these details -->
        ...
        <div class="col-md-4">
            <div class="side-section mt-5">
                ...
                <a href="eventsearch.jsp" class="btn btn-success btn-block">Booking Details</a>
                 <a href="contactussearch.jsp" class="btn btn-success btn-block">Contact Us Details</a>
                <a href="HiringPersearch.jsp" class="btn btn-warning btn-block">Hiring Performance</a>
                <a href="${cusupdate}" class="btn btn-info btn-block">Edit Profile</a>
                
    <c:url value="cusprofiledelete.jsp" var="cusdelete">
		<c:param name="id" value="${id}"/><!-- CID is the variable name of set tag above -->
		<c:param name="name" value="${name}"/>
		<c:param name="address" value="${address}"/>
		<c:param name="email" value="${email}"/>
		...
		<c:param name="password" value="${password}"/>
    				 ...
    				 <a href="${cusdelete}" name="delete" class="btn btn-danger btn-block">Delete Account</a>
