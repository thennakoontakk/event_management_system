...
<% //catch the details come from url in useraccount page
    ...
    <div class="container01">
        ...
        <form id="registration-form" action="delete" method="post">
            ...
            <button type="submit" name="sumbit" id="register-button" class="btn btn-danger btn-block" >Delete Account</button>
